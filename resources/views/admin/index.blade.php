    ...
    <div class="col-xs-12">
        ...
        ">
            ...
            <div class="box-body">
                ...
                @else
                    Your panel is <strong>not up-to-date!</strong> The latest version is <a href="https://github.com/Xiled0001/chalixus-panel/releases/v{{ $version->getPanel() }}" target="_blank"><code>{{ $version->getPanel() }}</code></a> and you are currently running version <code>{{ config('app.version') }}</code>.
                @endif
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-xs-6 col-sm-3 text-center">
        <a href="https://github.com/Xiled0001/chalixus-panel"><button class="btn btn-primary" style="width:100%;"><i class="fa fa-fw fa-support"></i> GitHub</button></a>
    </div>
    <div class="col-xs-6 col-sm-3 text-center">
